...
<head>
    ...
    <!--Core CSS -->
    <link href="${pageContext.request.contextPath}/static/bs3/css/bootstrap.min.css" rel="stylesheet">
    ...
    <link href="${pageContext.request.contextPath}/static/css/clndr.css" rel="stylesheet">
     ...
     <!--dynamic table-->
    <link href="${pageContext.request.contextPath}/static/js/advanced-datatable/css/demo_page.css" rel="stylesheet" />
    <link href="${pageContext.request.contextPath}/static/js/advanced-datatable/css/demo_table.css" rel="stylesheet" />
    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/js/data-tables/DT_bootstrap.css" />
    
    
    
    <!--clock css-->
    <link href="${pageContext.request.contextPath}/static/js/css3clock/css/style.css" rel="stylesheet">
    <!--Morris Chart CSS -->
    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/js/morris-chart/morris.css">
    <!-- Custom styles for this template -->
    <link href="${pageContext.request.contextPath}/static/css/style.css" rel="stylesheet">
    <link href="${pageContext.request.contextPath}/static/css/style-responsive.css" rel="stylesheet"/>
    
    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/js/file-uploader/css/jquery.fileupload.css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/js/file-uploader/css/jquery.fileupload-ui.css">
    ...
    <ul class="nav top-menu">
        ...
        <li id="header_inbox_bar" class="dropdown">
            ...
            <ul class="dropdown-menu extended inbox">
                ...
                <li>
                    <a href="index.html#">
                        <span class="photo"><img alt="avatar" src="${pageContext.request.contextPath}/static/images/avatar-mini.jpg"></span>
                                <span class="subject">
                ...
                <li>
                    <a href="index.html#">
                        <span class="photo"><img alt="avatar" src="${pageContext.request.contextPath}/static/images/avatar-mini-2.jpg"></span>
                                <span class="subject">
                ...
                <li>
                    <a href="index.html#">
                        <span class="photo"><img alt="avatar" src="${pageContext.request.contextPath}/static/images/avatar-mini-3.jpg"></span>
                                <span class="subject">
...
<div class="top-nav clearfix">
    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="index.html#">
                <img alt="" src="${pageContext.request.contextPath}/static/images/avatar1_small.jpg">
