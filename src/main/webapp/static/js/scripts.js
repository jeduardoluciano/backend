(function ($) {
    ...
    $("#ShowLocationGoogleMaps").on("click", function(event){
 	   var name = $('.nameAddress').val();
 	   var number = $('.numberAddress').val();
 	   var city = $('.cityAddress').val();
 	   var district = $('.districtAddress').val();
 	   
 	   var address = name + "," + number + "," + district + "," + city ;
    ...
    $("#saveJSON").on("click", function(param){
 	   $.ajax({
            type: "GET",
            url: urlApp + $("#controller").val() + "saveJSON",
            dataType: "json",
            success: function(data) {
